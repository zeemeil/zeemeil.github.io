...
令$$ \mathsf{d} = \gamma_{\mathsf{x}} - \alpha_{\mathsf{x}}, \mathsf{e} = \gamma_{\mathsf{y}} - \alpha_{\mathsf{y}}, \mathsf{f} = (\gamma_{\mathsf{x}}\gamma_{\mathsf{y}} + \psi) - \chi $$，验证$$\mathsf{d}\mathsf{e} = \mathsf{f} $$判断$$\chi $$正确性
